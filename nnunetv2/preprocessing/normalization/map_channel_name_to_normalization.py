...
from nnunetv2.preprocessing.normalization.default_normalization_schemes import CTNormalization, NoNormalization, \
    ZScoreNormalization, RescaleTo01Normalization, RGBTo01Normalization, RescaleTo01FenetrageNormalization, ImageNormalization
...
channel_name_to_normalization_mapping = {
    ...
    'rescale_to_0_1_fenetrage': RescaleTo01FenetrageNormalization,
}
