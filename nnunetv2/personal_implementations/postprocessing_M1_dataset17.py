...
for fold in range(FOLDS_NUMBER):
    masks_m11_path = f'/beegfs/azanella/data_challenge/nnUNet/nnUNet_raw/training/Dataset017_M1_mask/val_data/fold_{fold}/imagesTr/'
    preds_m17_path = f'/beegfs/azanella/data_challenge/nnUNet/nnUNet_raw/training/Dataset017_M1_mask/val_data/fold_{fold}/prediction_1000_best/'
    preds_output_path = f'/beegfs/azanella/data_challenge/nnUNet/nnUNet_raw/training/Dataset017_M1_mask/val_data/fold_{fold}/prediction_output/'
