...
for fold in range(FOLDS_NUMBER):
    masks_m11_path = f'/beegfs/azanella/data_challenge/nnUNet/nnUNet_raw/training/{dataset}/val_data/fold_{fold}/imagesTr/'
    preds_m17_path = f'/beegfs/azanella/data_challenge/nnUNet/nnUNet_raw/training/{dataset}/val_data/fold_{fold}/prediction_1000_best/'
    preds_output_path = f'/beegfs/azanella/data_challenge/nnUNet/nnUNet_raw/training/{dataset}/val_data/fold_{fold}/prediction_output/'
    ...
    for i in range(len(masks_m11_fold)):
        ...
        seg_new[mask_m11_npy == 4] = 2
        seg_new[pred_m17_npy == 1] = 3
        seg_new[pred_m17_npy == 2] = 4
