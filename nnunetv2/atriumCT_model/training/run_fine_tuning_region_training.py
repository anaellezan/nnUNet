...
def main():
    ...
    pretrained_weights_path = '/media/sharedata/atriumCT/atrium_nnunet/nnUNet_preprocessed/Dataset005_LA_CT00_corrected_voted_region/checkpoint_best_Dataset002_fold_0_3d_fullres_500_epochs.pth'
