...
def main():
    ...
    #pretrained_weights_path = '/media/sharedata/atriumCT/atrium_nnunet/nnUNet_preprocessed/Dataset004_LA_CT00_corrected_voted/checkpoint_best_Dataset002_fold_0_3d_fullres.pth'
