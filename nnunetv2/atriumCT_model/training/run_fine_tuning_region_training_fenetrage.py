''' LAST VERSION FOR FINE TUNING LABELS from checkpoint_best_Dataset002_fold_0_3d_fullres_500_epochs.
in dataset.json using 'rescale_to_0_1_fenetrage' (remove it from json if you want the classic normalization scheme)
and LRExpDecayScheduler (uncomment row in nnUNetTrainer.py if you prefer PolyLRScheduler).
'''
...
def plan_and_preprocess():
    ...
    preprocess(
        dataset_ids=[DATASET_ID_TO_TRAIN],
        configurations=CONFIGURATION_TO_TRAIN,
...
def main():
    ...
    # /!\ décommenter seulement si l'on veut preprocesser
    # preprocess(
