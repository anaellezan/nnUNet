''' This script computes metrics on mask predictions. '''
...
ref_label_files = [
    ...
    + f.replace('la_trans_corrected', 'la_lables_opa_defect')
    for f in files
]
...
def main():
    ...
    df = pd.read_csv(
        f'/media/sharedata/atriumCT/atrium_nnunet/raw_data/{dataset}/prediction_3d_dataset002/patients_history.csv'
    )
